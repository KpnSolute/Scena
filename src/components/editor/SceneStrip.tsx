...
export interface SceneStripProps {
  ...
  onUpdateScene?: (sceneId: string, patch: Partial<Pick<BoardScene, "name" | "duration_ms" | "transition_type" | "is_hidden">>) => void;
  onDuplicate?: (sceneId: string) => void;
  onDelete?: (sceneId: string) => void;
}

export function SceneStrip({ scenes, selectedSceneId, onSelect, onAddScene, onReorder, onUpdateScene = () => {}, onDuplicate, onDelete }: SceneStripProps) {
